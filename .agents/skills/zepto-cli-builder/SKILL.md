...
4. Automation behavior.
   ...
   - Support/help, invoice/receipt, refund/return/cancel, and rating/review order-action label matching should use `src/automation/order-action-labels.ts`; do not add per-module copies that can drift across account, address, cart, order, login, search, product-add, or parser surfaces.
