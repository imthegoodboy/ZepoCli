...
4. Automation behavior.
   ...
   - Cart and order totals must come from explicit total/payable labels; never report `Item total` or `Subtotal` as final cart totals, and never infer totals from arbitrary product, fee, discount, or badge prices.
