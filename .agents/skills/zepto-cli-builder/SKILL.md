...
4. Automation behavior.
   ...
   - Final payment/order-placement label matching should use `src/automation/final-action-labels.ts`; use it for browser click guards and DOM-evaluated product/cart/search parsers so amount-bearing pay, checkout-and-pay, and pay-with labels do not drift per module.
