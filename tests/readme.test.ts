...
describe("README package guidance", () => {
  ...
  it("documents the agent preflight and checkout handoff contract", () => {
    ...
    expect(readme).toContain("checkout/payment panels, cart/checkout service rows, promo gift panels, offer/upsell panels, merchandising headings, membership rows, and image alt/accessibility text");
