...
describe("agent guidance", () => {
  ...
  it("keeps future-agent address and payment safety boundaries explicit", () => {
    for (const guidance of [agentReadme, builderSkill]) {
      ...
      expect(guidance).toContain("checkout/payment panels, cart/checkout service rows such as fees, charges, taxes, and GST, promo gift panels, offer/upsell panels, merchandising headings, membership rows");
