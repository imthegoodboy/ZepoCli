...
6. Storage behavior.
   ...
   - Browser context close should be bounded and best-effort so a stuck Playwright close does not keep the CLI process alive indefinitely or strand the data-dir lock forever.
