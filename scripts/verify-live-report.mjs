...
Use --require-production-scope for final readiness: it also requires browser preflight, local status, live session, search, address selection, add, cart, checkout handoff, and track to be requested and covered without focused cleanup/history workflows.
