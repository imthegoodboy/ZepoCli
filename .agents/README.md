...
- Product extraction should ignore text that Zepto exposes as product-card control labels when choosing product names, and ADD-control mapping should reject mixed controls whose labels are not explicit product-add labels.
