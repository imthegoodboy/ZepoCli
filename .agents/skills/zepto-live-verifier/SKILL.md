...
- ZepoCli may generate a QR for the fixed Zepto checkout link only; Zepto's payment-page UPI QR is a live payment instrument and must stay in Zepto's visible UI.
